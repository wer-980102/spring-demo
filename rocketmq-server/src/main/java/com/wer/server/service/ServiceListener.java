...
public class ServiceListener implements RocketMQListener<MessageExt> {

    private static final Logger logger = LoggerFactory.getLogger(ServiceListener.class);

    @Autowired
    private ServerServerImpl serverServer;
    ...
    public void onMessage(MessageExt messageExt){
        try {
            ...
            String clientInfo = serverServer.getServiceInfo(mess);
