...
public class ElasticSearchSqlUtil {
    ...
    public static JSONObject query(String sql, Map<String, Object> params) {
        ...
        JSONObject response = JSONUtil.parseObj(HttpUtil.post("http://"+node+"/_nlpcn/sql", JSONUtil.toJsonStr(query)));
    ...
    public static <T> List<T> query(String sql, Map<String, Object> params, Class<T> className) {
        ...
        JSONObject response = JSONUtil.parseObj(HttpUtil.post("http://"+node+"/_sql?format=json", JSONUtil.toJsonStr(query)));
    ...
    public static void main(String[] args) {
        List<Long> query = query("select * from parking_es_access_info ", null, Long.class);
        query.forEach(it -> System.out.println(JSONUtil.toJsonStr(it)));
    }
